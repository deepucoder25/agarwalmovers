<section class="breadcrumb-hero"
    ...
    <div class="container d-flex justify-content-center">
        <div class="hero-box text-center">
            <h1 class="page-title d-block">Good Insurance</h1>
    ...
    <div class="container py-4">
        ...
        <div class="content-box mb-4">
            <h3 class="fw-bold mb-3">
                Why People Add Goods Insurance
            </h3>

            <p>
                Packing and handling are done carefully, but transport still involves movement from one point to another. Roads, weather, and travel time can vary.
            </p>
