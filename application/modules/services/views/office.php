<section class="breadcrumb-hero"
    ...
    <div class="container d-flex justify-content-center">
        <div class="hero-box text-center">
            <h1 class="page-title d-block">Office Shifting Service</h1>
            ...
            <ol class="breadcrumb breadcrumb-custom justify-content-center mb-0">
                ...
                <li class="breadcrumb-item active text-white">
                    <span>Office Shifting Service</span>
                </li>
            </ol>
        </div>
    </div>
    ...
    <div class="container py-4">
        ...
        <div class="content-box mb-4">
            <h3 class="fw-bold mb-3">
                Affordable Office Shifting Services That Stay Practical
            </h3>
        ...
        <div class="content-box">
            <h4 class="fw-bold mb-3">
                Real Situations During Office Moves
            </h4>
