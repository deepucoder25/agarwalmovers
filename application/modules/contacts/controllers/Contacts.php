...
class Contacts extends MX_Controller
{
    ...
    function index()
    {
        $data['title'] = "Contact Packers Movers | Get Free Moving Quote";
        $data['description'] = "Contact our packers and movers for quick quotes, bookings, and support. Get reliable relocation services with safe and affordable solutions.";
